...
- Soils -- 
  ...
  - Heavy metal elements below EPA human hazard levels *[@EPA]*
```{r}
# knitr::include_graphics(here::here("tables/chem.png"))
...
```{r crops}
source(here::here("tables/crops.R")); cropTbl %>% distinct() %>% #quiet?
  knitr::kable(caption = "Cover crop mixes") %>% kableExtra::kable_styling()
```
...
- Weed Suppression mix reduced weed Density and Richness (but less so Cover) vs. Null, Perennial, and Compaction mixes (significantly)
  - Weed Suppression did reduce weed Dover vs. Null mix (significantly)
