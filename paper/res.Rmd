...
<!-- or  -->
~`r diffTN / filter(compData_TIL, TIL=="No")$median *100`%
) compared to no-till, 
down to 
...
<!-- or  -->
~`r diffRN / filter(compData_TIL, TIL=="No")$median *100`%
...
<!-- or  -->
~`r diffTR / filter(compData_TIL, TIL=="Roto")$median *100`%
) between tractor- and roto-till among all cover crop mixes (Fig \@ref(fig:compactFig)a).
<!-- test-static-vals? -->

```{r compactFig, fig.width=6, fig.height=3, fig.cap="Compaction data (a) by tillage, and (b) cover crop mix. Gray dots show plot medians and black point ranges show group mean ± 1 std error and may be small. Significant pairwise post-hoc Wilcoxon test outcomes shown (**** p < 0.0001, *** p < 0.001, ** p < 0.01, * p < 0.05, *^ p < 0.1, ^ p > 0.1 or ns)"}
...
<!-- or  -->
~`r diffPN / filter(compData_MIX, MIX=="null")$median *100`%
...
<!-- (`r conv_unit(filter(infilData_TIL, TIL=="Roto")$median, "ml_per_sec", "gal_per_min")` ± `r conv_unit(filter(infilData_TIL, TIL=="Roto")$mad, "ml_per_sec", "gal_per_min")` gal per min) -->
(Fig \@ref(fig:infilFig)a).


```{r infilFig, fig.height=2, fig.width=4, fig.cap="Infiltration data (a) by tillage, and (b) cover crop mix. Gray dots show plot medians and black point ranges show group mean ± 1 std error and may be small. Significant pairwise post-hoc Wilcoxon test outcomes shown (**** p < 0.0001, *** p < 0.001, ** p < 0.01, * p < 0.05, *^ p < 0.1, ^ p > 0.1)"}
