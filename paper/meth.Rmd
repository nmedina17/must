...
and nutrient levels, including concentrations of heavy metals like lead and arsenic *(data not shown)* which were present below harmful government human-contact standards ([cfpub.epa.gov/ecotox](cfpub.epa.gov/ecotox)).
...
`r filter(chem, variable == "resp_mg_day") %>% .$mad %>% round(digits = 3)` mg per day 
